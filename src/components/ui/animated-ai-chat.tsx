...
export function AnimatedAIChat() {
    ...
    const commandSuggestions: CommandSuggestion[] = [
        { 
            ...
            label: "Generate code", 
            description: "Generate code from your prompt or idea", 
            prefix: "/code" 
        },
        { 
        ...
        { 
            ...
            label: "UI components", 
            description: "Build and preview reusable UI components", 
            prefix: "/components" 
        },
        { 
            icon: <Rocket className="w-4 h-4" />, 
            label: "Launch app", 
            description: "Launch your project in a live environment", 
            prefix: "/app" 
        },
    ];
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
            ...
            <div className="w-full max-w-2xl mx-auto relative">
                ...
                >
                    <div className="text-center space-y-3">
                        ...
                        >
                            Get started by entering your question or command in the box below
                        </motion.p>
                    </div>
            ...
            <AnimatePresence>
                {isTyping && (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-7 rounded-full bg-white/[0.05] flex items-center justify-center text-center">
                                <span className="text-xs font-medium text-white/90 mb-0.5">Syl20</span>
                            </div>
